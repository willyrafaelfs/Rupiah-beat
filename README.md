...
- 📈 **Live price chart** — smooth Bezier line drawn frame-by-frame on a pure HTML5 Canvas, with dynamic red (up) / green (down) trend coloring. Hover to see a tooltip with price, date/time, and trend direction.
